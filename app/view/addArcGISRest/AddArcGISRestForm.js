Ext.define('CpsiMapview.view.addArcGISRest.AddArcGISRestForm', {
    ...
    requires: [
        'CpsiMapview.controller.addArcGISRest.AddArcGISRestFormController'
    ],
    ...
    viewModel: {
        data: {
            ...
            documentation:
                '<h2>Add ArcGIS REST layer</h2>• In this dialog you can add any desired map service to the map with the ' +
