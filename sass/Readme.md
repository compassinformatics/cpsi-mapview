...
folder are mapped to the application's root namespace, 'CpsiMapview'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "CpsiMapview"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'CpsiMapview' in the same way
as `"CpsiMapview/sass/src"`.
